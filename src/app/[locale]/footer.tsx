    ...
    return (
        <footer className="w-full absolute bottom-0 mt-8 mx-auto px-4 pb-16">
            ...
            <div className="flex justify-center items-center space-x-6 text-gray-800">
                ...
                <a href="/terms-of-service" className="text-gray-400 hover:opacity-90">Terms of Use</a>
                <a href="/privacy-policy" className="text-gray-400 hover:opacity-90">Privacy Policy</a>
