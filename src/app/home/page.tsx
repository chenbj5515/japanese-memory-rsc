    ...
    <div className="min-h-screen bg-white">
      ...
      {showDemo ? (
        <div className="fixed w-[100vw] h-[100vh] left-[0] top-[0] backdrop-blur-[3px] backdrop-saturate-[180%] z-[10] flex items-center justify-center">
          <div
            ref={containerRef}
            className={`demo-card-container ${showDemo === 'word' && !showMemoCard ? 'w-auto min-w-[228px]' : showDemo === 'exam' || showDemo === 'daily' ? 'border border-[#1d283a] rounded-[12px] bg-[#fcfcfd] w-[880px] h-[calc(100vh-2px)] overflow-hidden scrollbar-hide' : 'w-[628px]'} relative transform`}
            style={{
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 flex -space-x-4 rotate-[-5deg] group">
            ...
            >
              <div className="p-6 h-[100%] border border-[#1d283a] rounded-[12px]">
                <h3 className="text-lg font-medium">Memo Card</h3>
                <div
                ...
                <p className="text-sm text-[#49494b] mt-10 leading-snug">
                  Translation, pronunciation, shadowing, and dictation - all in one elegant card.
                </p>
              </div>
            </div>
            ...
            >
              <div className="p-6 h-[100%] border border-[#1d283a] rounded-[12px]">
                <h3 className="text-lg font-medium">Word Card</h3>
                <div
                  className="flex max-h-[236px] justify-center mt-8 cursor-pointer"
                ...
                <p className="text-sm text-[#49494b] mt-10 leading-snug">
                  Recall which sentence a word appeared in, and check with a single tap if you can't remember.
                </p>
              </div>
            </div>
            ...
            >
              <div className="p-6 h-[100%] border border-[#1d283a] rounded-[12px]">
                ...
                <p className="text-sm text-[#49494b] mt-4 leading-snug">
                  Test your knowledge and ensure true mastery of what you've learned.
                </p>
              </div>
            </div>
            ...
            >
              <div className="p-6 h-[100%] border border-[#1d283a] rounded-[12px]">
                ...
                <p className="text-sm text-[#49494b] mt-4 leading-snug">
                  5 minutes before bed. Review what you've forgotten. Stay on track.
                </p>
              </div>
            </div>
          </div>
